...
Lemma~\ref{lem:small-products}, Lemma~\ref{lem:proper}, and
Proposition~\ref{prop:degree} are not formalized; their global fibre
estimate enters the final Lean theorem as the hypothesis
\texttt{GlobalFibreBound}.
